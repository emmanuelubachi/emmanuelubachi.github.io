export const PROJECT = [
  ...
  {
    title: "Car Hub - Find, Book, or rent a car — quicly and easily!",
    desc: "Developed an online car hub platform for finding, booking, and renting cars with ease. Leveraged React, Next.js, and TypeScript to ensure a seamless and efficient user experience while optimizing for search engine visibility (SEO).",
    imgSrc: "/carhub.png",
    imgAlt: "Car Hub - Find, Book, or Rent a Car Project Image",
    projUrl: "https://car-showcase-roan-nu.vercel.app/",
    badge: [
      { label: "React" },
      { label: "Next JS 13" },
      { label: "TypeScript" },
